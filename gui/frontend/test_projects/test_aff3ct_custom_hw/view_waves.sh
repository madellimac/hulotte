...
if [ -f "waveform.vcd" ]; then
    ...
    echo "Please run the simulation first: ./build/test_aff3ct_custom_hw"
    exit 1
fi
...
if command -v surfer &> /dev/null; then
    ...
    SURFER_BIN="./surfer"
elif [ -f "/home/cleroux/PROJECTS/hulotte/tools/surfer" ]; then
    SURFER_BIN="/home/cleroux/PROJECTS/hulotte/tools/surfer"
fi
