...
{
    std::cout << "========================================" << std::endl;
    std::cout << "Example 3: StreamPU + Custom + AFF3CT" << std::endl;
    std::cout << "========================================" << std::endl;

#ifndef HULOTTE_USE_AFF3CT
    std::cerr << "Error: AFF3CT not enabled!" << std::endl;
    std::cerr << "Rebuild with -DHULOTTE_USE_AFF3CT=ON" << std::endl;
    return 1;
#else
